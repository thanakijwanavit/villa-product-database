...
__all__ = ['DATABASE_TABLE_NAME', 'INVENTORY_BUCKET_NAME', 'INPUT_BUCKET_NAME', 'REGION', 'ACCESS_KEY_ID',
           'SECRET_ACCESS_KEY', 'LINEKEY', 'ProductDatabase', 'setNoUpdate', 'setUpdate', 'fromDict', 'updateWithDict',
           'ProductsFromList', 'lambdaProductsFromList', 'dumpToS3', 'lambdaDumpToS3', 'Product', 'ValueUpdate',
           'chunks', 'valueUpdate', 'valueUpdate2', 'lambdaUpdateProduct', 'updateS3Input', 'lambdaUpdateS3',
